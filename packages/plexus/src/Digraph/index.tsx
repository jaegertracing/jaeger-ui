...
const Digraph = <T = unknown, U = unknown>({
  ...
  React.useEffect(() => {
    if (zoomEnabled) {
      const onZoomUpdated = (zoomTransform: ZoomTransform) => {
    ...
    // ✅ FIX: Return undefined when zoomEnabled is false
    return undefined;
  }, [zoomEnabled]);

  // ✅ Update zoom element when rootRef is ready
  React.useEffect(() => {
