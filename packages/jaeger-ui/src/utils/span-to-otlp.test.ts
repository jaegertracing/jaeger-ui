...
function makeSpan(overrides: Partial<IOtelSpan> = {}): IOtelSpan {
  return {
    ...
    startTime: 1_700_000_000_000_000 as unknown as number,
    endTime: 1_700_000_000_050_000 as unknown as number,
    duration: 50_000 as unknown as number,
    attributes: [
    ...
    hasChildren: false,
    childSpans: [],
    relativeStartTime: 0 as unknown as number,
    inboundLinks: [],
    warnings: null,
