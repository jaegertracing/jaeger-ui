...
const defaultConfig: Config = {
  ...
  monitor: {
    ...
    tagFilters: [
      ...
      { label: 'Environment: Development', value: 'environment:dev' },
      { label: 'Version: v1.0', value: 'version:v1.0' },
      { label: 'Version: v2.0', value: 'version:v2.0' },
      { label: 'Region: US East', value: 'region:us-east' },
      { label: 'Region: US West', value: 'region:us-west' },
      { label: 'Region: Europe', value: 'region:europe' },
    ],
  },
