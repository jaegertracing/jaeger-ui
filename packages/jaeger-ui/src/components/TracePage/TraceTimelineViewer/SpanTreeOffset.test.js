...
describe('SpanTreeOffset', () => {
  ...
  describe('icon', () => {
    ...
    it('does not render icon if props.span.hasChildren is false', () => {
      ...
      expect(wrapper.find(IoChevronForwardOutline).length).toBe(0);
      expect(wrapper.find(IoChevronDownOutline).length).toBe(0);
    });
    ...
    it('renders IoChevronForwardOutline if props.span.hasChildren is true and props.childrenVisible is false', () => {
      expect(wrapper.find(IoChevronForwardOutline).length).toBe(1);
      expect(wrapper.find(IoChevronDownOutline).length).toBe(0);
    });

    it('renders IoChevronDownOutline if props.span.hasChildren is true and props.childrenVisible is true', () => {
      wrapper.setProps({ childrenVisible: true });
      expect(wrapper.find(IoChevronForwardOutline).length).toBe(0);
      expect(wrapper.find(IoChevronDownOutline).length).toBe(1);
    });
