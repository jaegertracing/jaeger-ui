...
const CATEGORY_FILTER = 'jaeger/ux/ddg/filter';
export const CATEGORY_MATCH_INTERACTIONS = 'jaeger/ux/ddg/match-interactions';
const CATEGORY_SEARCH = 'jaeger/ux/ddg/search';
...
const ACTION_CLEAR_OPERATION = 'clear-operation';
...
const ACTION_SET_SERVICE = 'set-service';
