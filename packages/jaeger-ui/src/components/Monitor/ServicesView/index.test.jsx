...
vi.mock('../MultiTagSelector/MultiTagSelector.jsx', async () => {
  return mockDefault(function MultiTagSelector({ onChange }) {
    return (
      <div>
        <h2>Tags</h2>
        <select data-testid="tags-selector" onChange={e => onChange(e.target.value)}>
