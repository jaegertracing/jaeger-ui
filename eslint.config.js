...
export default [
  ...
  // Test files (Jest)
  {
    ...
    rules: {
      ...
      // JSX A11y rules (matching old config)
      ...
      // React rules (matching old config)
      ...
      // Import rules (matching old config)
  ...
  // TS / TSX files
  {
    ...
    rules: {
      ...
      // General rules (inherited from old config)
      'arrow-body-style': 'off',
      'arrow-parens': ['warn', 'as-needed'],
      'class-methods-use-this': 'off',
      'comma-dangle': 'off',
      ...
      // TS-specific rules (matching old config overrides)
      ...
      // React rules for TypeScript files (matching old config overrides)
      'react/jsx-uses-react': 'error',
      'react/jsx-uses-vars': 'error',
      'react/destructuring-assignment': 'off',
      'react/jsx-curly-brace-presence': ['error', 'never'],
      ...
      'react/forbid-prop-types': 'warn',
      'react/function-component-definition': 'off',
      'react/require-default-props': 'off', // Disabled for TS files as per old config
      'react/default-props-match-prop-types': 'off', // Disabled for TS files as per old config
      'react/no-unused-prop-types': 'off', // Disabled for TS files as per old config
      'react/no-array-index-key': 'warn',
      'react/no-unused-class-component-methods': 'off',
      'react/jsx-props-no-spreading': 'off',
      'react/state-in-constructor': 'off',
