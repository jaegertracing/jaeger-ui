...
Adopt the **IBM Carbon-based** 20-color palette (Cyan prioritized first) implemented via the **Design Token Architecture** established in [ADR-0001](../adr/0001-design-token-based-theming.md).

### Implementation Principles

1.  **CSS Variable Orchestration**: All colors are defined in [`vars.css`](../../packages/jaeger-ui/src/components/common/vars.css) using `--span-color-N` tokens.
