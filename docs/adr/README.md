...
- [ADR-0008: State Management Migration — Implementation Plan](./0008-state-management-implementation-plan.md) - Phased execution plan, rollback, and success criteria (implements ADR-0004)
