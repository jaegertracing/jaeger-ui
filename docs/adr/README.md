...
- [ADR-0004: State Management Strategy for Jaeger UI](./0004-state-management-strategy.md) - Decision (Zustand + TanStack Query), phased migration plan off Redux, aligned with ADR 0005
