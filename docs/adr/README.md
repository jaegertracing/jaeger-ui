...
- Header block: Status and Date, plus Tracking Issue and Related links where useful. Statuses in use: Accepted, Implemented, Documented existing implementation, Superseded.
