...
- Remove unused redux-async-middleware package ([@anshgoyalevil](https://github.com/anshgoyalevil) in [#1674](https://github.com/jaegertracing/jaeger-ui/pull/1674))
- Remove unused source-map-explorer package ([@anshgoyalevil](https://github.com/anshgoyalevil) in [#1671](https://github.com/jaegertracing/jaeger-ui/pull/1671))
- Remove unused d3-scale package ([@anshgoyalevil](https://github.com/anshgoyalevil) in [#1670](https://github.com/jaegertracing/jaeger-ui/pull/1670))
...
- Bump eslint-plugin-react from 7.32.2 to 7.33.1 ([@dependabot](https://github.com/dependabot) in [#1617](https://github.com/jaegertracing/jaeger-ui/pull/1617))
- Migrate App/Page.test.js from Enzyme to RTL ([@anshgoyalevil](https://github.com/anshgoyalevil) in [#1659](https://github.com/jaegertracing/jaeger-ui/pull/1659))
- Bump prettier from 3.0.0 to 3.0.1 ([@dependabot](https://github.com/dependabot) in [#1634](https://github.com/jaegertracing/jaeger-ui/pull/1634))
- Bump lerna from 7.1.3 to 7.1.5 ([@dependabot](https://github.com/dependabot) in [#1657](https://github.com/jaegertracing/jaeger-ui/pull/1657))
...
- Bump the vite group with 2 updates ([@dependabot](https://github.com/dependabot) in [#1642](https://github.com/jaegertracing/jaeger-ui/pull/1642))
- Bump the typescript-eslint group with 2 updates ([@dependabot](https://github.com/dependabot) in [#1646](https://github.com/jaegertracing/jaeger-ui/pull/1646))
- Bump eslint-config-prettier from 8.9.0 to 9.0.0 ([@dependabot](https://github.com/dependabot) in [#1638](https://github.com/jaegertracing/jaeger-ui/pull/1638))
- Bump cytoscape from 3.25.0 to 3.26.0 ([@dependabot](https://github.com/dependabot) in [#1639](https://github.com/jaegertracing/jaeger-ui/pull/1639))
- Bump the babel group with 4 updates ([@dependabot](https://github.com/dependabot) in [#1645](https://github.com/jaegertracing/jaeger-ui/pull/1645))
...
- Bump the vite group with 2 updates ([@dependabot](https://github.com/dependabot) in [#1619](https://github.com/jaegertracing/jaeger-ui/pull/1619))
- Bump eslint from 8.44.0 to 8.46.0 ([@dependabot](https://github.com/dependabot) in [#1614](https://github.com/jaegertracing/jaeger-ui/pull/1614))
- Bump prettier from 2.8.8 to 3.0.0 ([@dependabot](https://github.com/dependabot) in [#1553](https://github.com/jaegertracing/jaeger-ui/pull/1553))
- Bump the typescript-eslint group with 2 updates ([@dependabot](https://github.com/dependabot) in [#1561](https://github.com/jaegertracing/jaeger-ui/pull/1561))
- Bump the vite group with 2 updates ([@dependabot](https://github.com/dependabot) in [#1564](https://github.com/jaegertracing/jaeger-ui/pull/1564))
- Bump the babel group with 1 update ([@dependabot](https://github.com/dependabot) in [#1563](https://github.com/jaegertracing/jaeger-ui/pull/1563))
- Bump the babel group with 4 updates ([@dependabot](https://github.com/dependabot) in [#1560](https://github.com/jaegertracing/jaeger-ui/pull/1560))
- Bump vite from 4.3.9 to 4.4.2 ([@dependabot](https://github.com/dependabot) in [#1558](https://github.com/jaegertracing/jaeger-ui/pull/1558))
- Bump tough-cookie from 4.1.2 to 4.1.3 ([@dependabot](https://github.com/dependabot) in [#1559](https://github.com/jaegertracing/jaeger-ui/pull/1559))
